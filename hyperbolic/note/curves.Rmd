...
　双曲線関数の1つであるcosh関数(ハイパボリックコサイン関数・hyperbolic cosine function)をグラフで確認します。\
\
...
　双曲線関数の1つであるtanh関数(ハイパボリックタンジェント関数・hyperbolic tangent function)をグラフで確認します。\
\
