...
　弧度法における角度$0 \leq t \leq \frac{\pi}{2}$を作成して、半径が$\cosh \theta$の孤(原点からの長さが$\cosh \theta$の点)の座標を計算します。この$t$は、度数法における$0^{\circ}$から$90^{\circ}$の角度に対応します。\
...
　弧度法における角度を作成して、半径が$\mathrm{csch}\ \theta$の絶対値の孤(原点からの長さが$|\cosh \theta|$の点)の座標を計算します。$\theta > 0$のときは$0 \leq t \leq \frac{\pi}{2}$、$\theta = 0$のときは$t = 0$、$\theta < 0$のときは$\pi \leq t \leq \frac{3 \pi}{2}$の角度を使います。$\theta$が正の値のときの$t$は度数法における$0^{\circ}$から$90^{\circ}$の角度、$\theta$が$0$のときは$0^{\circ}$、$\theta$が負の値のときは$180^{\circ}$から$270^{\circ}$の角度に対応します。\
　半径が$a$の円のx軸の値は$x = a \cos t$、y軸の値は$y = a \sin t$で計算できます。\
　絶対値は`abs()`で計算できます。\
...
　弧度法における角度を作成して、半径が$\mathrm{coth}\ \theta$の絶対値の孤(原点からの長さが$|\cosh \theta|$の点)の座標を計算します。$\theta > 0$のときは$0 \leq t \leq \frac{\pi}{2}$、$\theta = 0$のときは$t = 0$、$\theta < 0$のときは$\pi \leq t \leq \frac{3 \pi}{2}$の角度を使います。$\theta$が正の値のときの$t$は度数法における$0^{\circ}$から$90^{\circ}$の角度、$\theta$が$0$のときは$0^{\circ}$、$\theta$が負の値のときは$180^{\circ}$から$270^{\circ}$の角度に対応します。\
　半径が$a$の円のx軸の値は$x = a \cos t$、y軸の値は$y = a \sin t$で計算できます。\
　絶対値は`abs()`で計算できます。\
...
　弧度法における角度を作成して、半径が$f(\theta)$の絶対値の孤(原点からの長さが$|f(\theta)|$の点)の座標を計算します。$\theta > 0$のときは$0 \leq t \leq \frac{\pi}{2}$、$\theta = 0$のときは$t = 0$、$\theta < 0$のときは$\pi \leq t \leq \frac{3 \pi}{2}$の角度を使います。ただし、cosh関数については、正の値のみをとるので、$0 \leq t \leq \frac{\pi}{2}$を使います。$\theta$が正の値のときの$t$は度数法における$0^{\circ}$から$90^{\circ}$の角度、$\theta$が$0$のときは$0^{\circ}$、$\theta$が負の値のときは$180^{\circ}$から$270^{\circ}$の角度に対応します。\
　半径が$a$の円のx軸の値は$x = a \cos t$、y軸の値は$y = a \sin t$で計算できます。\
　絶対値は`abs()`で計算できます。\
