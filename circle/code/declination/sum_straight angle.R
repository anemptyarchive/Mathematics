...
ggplot() + 
  ...
  labs(title = "sum of declination angle and pi", 
...
angle_label_vec <- c("theta", "tau == pi + theta")
...
gganimate::animate(
  ...
  renderer = gganimate::av_renderer(file = "circle/figure/angle/sum_pi_circle.mp4")
)
